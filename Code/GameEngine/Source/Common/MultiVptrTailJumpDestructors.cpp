...
class Rva002CEDC0MultiTailDtor : public Rva0004418EMultiBase, public TailMixinA, public TailMixinWide, public TailMixinB
{
public:
	virtual ~Rva002CEDC0MultiTailDtor();
};

Rva002CEDC0MultiTailDtor::~Rva002CEDC0MultiTailDtor()
{
}
