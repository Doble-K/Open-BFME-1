...
// ------------------------------------------------------------------------------------------------
// ?ParticleSystemDebugDisplay@@YAXPAVDebugDisplayInterface@@PAXPAU_iobuf@@@Z matched 1345 bytes (Open-BFME5)
__declspec(naked) void ParticleSystemDebugDisplay(DebugDisplayInterface *, void *, FILE *)
{
	__asm
	{
		__emit 0x55;
