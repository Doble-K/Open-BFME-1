 ...
 *   3/4/98     GTH : Created.                                                                 *
 *=============================================================================================*/
// ?Blend_Update@HTreeClass@@QAEXABVMatrix3D@@PAVHAnimClass@@M1MM@Z matched 1746 bytes (Open-BFME5)
__declspec(naked) void HTreeClass::Blend_Update(const Matrix3D &, HAnimClass *, float, HAnimClass *, float, float)
{
	__asm
	{
		__emit 0x81;
