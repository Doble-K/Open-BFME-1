...
template _STL::_Rb_tree_iterator<NameKeyLocomotorPair, _STL::_Nonconst_traits<NameKeyLocomotorPair> > NameKeyLocomotorTree::insert_unique(NameKeyLocomotorTree::iterator, NameKeyLocomotorPair const &);
