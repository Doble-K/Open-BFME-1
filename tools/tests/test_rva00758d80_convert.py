#!/usr/bin/env python3
"""Prove the 0x00758D80 constant-return conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva00758D80Constant.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "int Rva00758D80()" in text
    assert "return 100000;" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x00758D80")
