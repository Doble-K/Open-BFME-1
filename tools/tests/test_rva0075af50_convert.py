#!/usr/bin/env python3
"""Prove the 0x0075AF50 byte-getter conversion is clean C++ and byte-matches retail.
...
def test_source_is_clean_cpp():
    ...
    assert "BFME_BYTE_FIELD_GETTER( Rva0075AF50, 0x3B2 )" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x0075AF50")
