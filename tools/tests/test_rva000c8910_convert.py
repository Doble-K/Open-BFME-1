#!/usr/bin/env python3
"""Prove the 0x000C8910 byte-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva000C8910ByteGetter.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned char Rva000C8910::get()" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x000C8910")
