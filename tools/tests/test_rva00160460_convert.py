#!/usr/bin/env python3
"""Prove the 0x00160460 byte-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva00160460ByteGetter.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned char Rva00160460::get()" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x00160460")
