#!/usr/bin/env python3
"""Prove the 0x0075B2E0 global-dword conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva0075B2E0GlobalDword.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned int Rva0075B2E0()" in text
    assert "return g_rva0075b2e0_value;" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x0075B2E0")
