#!/usr/bin/env python3
"""Prove the 0x000FBFA0 float-getter conversion is clean C++ and byte-matches retail.
...
def test_source_is_clean_cpp():
    ...
    assert "float Rva000FBFA0::get()" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x000FBFA0")
