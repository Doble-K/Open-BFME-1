#!/usr/bin/env python3
"""Prove the 0x004D7960 word-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "TinyWordFieldGetters_4D7960.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned short Rva004D7960::get() const" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x004D7960")
