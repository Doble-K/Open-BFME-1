#!/usr/bin/env python3
"""Prove the 0x0007BC40 dword-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "TinyDwordFieldGetters_7BC40.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned int NAME::get()" in text or "unsigned int Rva0007BC40::get()" in text
...
def test_build_py_matches_retail():
    ...
    assert "Functions: OK 3/3 matched" in output, output
