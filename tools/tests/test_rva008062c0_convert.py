#!/usr/bin/env python3
"""Prove the 0x008062C0 empty-body conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva008062C0Empty.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "void Rva008062C0()" in text
...
def test_build_py_matches_retail():
    ...
    assert "?Rva008062C0@@YAXXZ" in output, output
    print("PASS build.py matches retail 0x008062C0")
