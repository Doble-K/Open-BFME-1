#!/usr/bin/env python3
"""Prove the 0x0075B2D0 byte-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "TinyByteFieldGetters.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "BFME_BYTE_FIELD_GETTER( Rva0075B2D0, 0x48F )" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x0075B2D0")
