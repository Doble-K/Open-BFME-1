#!/usr/bin/env python3
"""Prove the 0x0075AF80 dword-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "Rva0075AF80DwordGetter.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned int Rva0075AF80::get()" in text
...
def test_build_py_matches_retail():
    ...
    assert "?get@Rva0075AF80@@QAEIXZ" in output, output
    print("PASS build.py matches retail 0x0075AF80")
