#!/usr/bin/env python3
"""Prove the 0x000C9010 word-getter conversion is clean C++ and byte-matches retail.
...
SOURCE = ROOT / "Code" / "GameEngine" / "Source" / "Common" / "TinyWordFieldGetters_C9010.cpp"
...
def test_source_is_clean_cpp():
    ...
    assert "unsigned short Rva000C9010::get() const" in text
...
def test_build_py_matches_retail():
    ...
    print("PASS build.py matches retail 0x000C9010")
