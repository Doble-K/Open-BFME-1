...
- `$L25660`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2/hlod.cpp` (95.7% of 23 compared bytes)
...
```
  c5f820:	8b 4d f0             	mov    ecx,DWORD PTR [ebp-0x10]
  c5f823:	e9 b8 30 d2 ff       	jmp    0x9828e0
```
