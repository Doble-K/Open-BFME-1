...
- best Zero Hour candidate agrees on 95.1% of the bytes outside relocation sites: 39 of
...
- `$L46964`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/RTS/PlayerList.cpp` (95.1% of 41 compared bytes)
