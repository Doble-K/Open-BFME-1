...
- `$L65872`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameClient/System/ParticleSys.cpp` (95.7% of 23 compared bytes)
...
```
  c0a0c0:	8b 4d f0             	mov    ecx,DWORD PTR [ebp-0x10]
  c0a0c3:	e9 78 79 d9 ff       	jmp    0x9a1a40
```
