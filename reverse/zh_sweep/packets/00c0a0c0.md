...
- that figure hides 5 blanked relocation slot(s): 1 of 43 compared byte(s) differ, and
...
- `$L65872`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameClient/System/ParticleSys.cpp` (97.7% aligned)
