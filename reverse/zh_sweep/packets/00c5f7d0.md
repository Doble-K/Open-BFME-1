...
- that figure hides 7 blanked relocation slot(s): 1 of 65 compared byte(s) differ, and
...
- `$L25573`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/Libraries/Source/WWVegas/WW3D2/hlod.cpp` (98.5% aligned)
- `$L25764`
