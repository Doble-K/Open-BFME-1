...
- best Zero Hour candidate agrees on 95.3% of the bytes outside relocation sites: 41 of
  43 compared byte(s) match
- the other 16 byte(s) of its 59-byte body are relocation slots, blanked before
...
- `$L74795`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngineDevice/Source/W3DDevice/GameClient/W3DScene.cpp` (95.3% of 43 compared bytes)
