...
- best Zero Hour candidate agrees on 94.9% of the bytes outside relocation sites: 93 of
  98 compared byte(s) match
- the other 56 byte(s) of its 154-byte body are relocation slots, blanked before
...
- `$L81389`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/RTS/Team.cpp` (94.9% of 98 compared bytes)
