...
- best Zero Hour candidate agrees on 90.6% of the bytes outside relocation sites: 29 of
  32 compared byte(s) match
- the other 24 byte(s) of its 56-byte body are relocation slots, blanked before
...
- `$L121639`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/RTS/Player.cpp` (90.6% of 32 compared bytes)
