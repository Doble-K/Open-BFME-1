...
- `$L74728`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngineDevice/Source/W3DDevice/GameClient/W3DScene.cpp` (91.3% of 23 compared bytes)
...
```
  c4b7d0:	8b 4d ec             	mov    ecx,DWORD PTR [ebp-0x14]
  c4b7d3:	e9 18 ee 3c ff       	jmp    0x1a5f0
```

## Callee pins (paste unresolved ones into reverse/symbols.csv)

```
??1SimpleSceneClass@@UAE@XZ,0x0001A5F0
```
