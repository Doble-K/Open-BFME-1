...
- best Zero Hour candidate agrees on 92.7% of the bytes outside relocation sites: 38 of
...
- `$L96254`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameClient/Drawable.cpp` (92.7% of 41 compared bytes)
