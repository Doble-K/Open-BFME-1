...
- best Zero Hour candidate agrees on 89.6% of the bytes outside relocation sites: 43 of
...
- `$L51932`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/StateMachine.cpp` (89.6% of 48 compared bytes)
