...
- that figure hides 5 blanked relocation slot(s): 2 of 51 compared byte(s) differ, and
...
- `$L46112`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/RTS/Science.cpp` (96.1% aligned)
