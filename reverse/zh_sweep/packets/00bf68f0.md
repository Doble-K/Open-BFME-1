...
- that figure hides 5 blanked relocation slot(s): 1 of 51 compared byte(s) differ, and
...
- `$L36513`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameClient/GameText.cpp` (98.0% aligned)
