...
- best Zero Hour candidate agrees on 85.3% of the bytes outside relocation sites
- that figure hides 8 blanked relocation slot(s): 11 of 75 compared byte(s) differ, and
...
- `$L83919`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameClient/GUI/ControlBar/ControlBar.cpp` (85.3% aligned)
