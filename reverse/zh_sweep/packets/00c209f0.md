...
- that figure hides 9 blanked relocation slot(s): 10 of 127 compared byte(s) differ, and
...
- `$L124317`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/GameLogic/Object/Object.cpp` (92.1% aligned)
