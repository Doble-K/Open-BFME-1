...
- that figure hides 3 blanked relocation slot(s): 2 of 35 compared byte(s) differ, and
...
- `$L113106`
  in `reference/CnC_Generals_Zero_Hour/GeneralsMD/Code/GameEngine/Source/Common/RTS/Player.cpp` (94.3% aligned)
