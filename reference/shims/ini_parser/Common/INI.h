// TU-scoped shim for the INI PARSER translation unit: BFME's INI layout with
// nothing inlined. ini.cpp defines the scanners and the tokeniser out of line
// -- they are its own matched rows -- so it cannot use ini_inline or
// ini_noinline, both of which still inline scanInt and scanPercentToReal for
// the consumer TUs. Keep the layout in step with those two.
