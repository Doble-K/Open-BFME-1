...
public:
	...
	// BFME's GameSpyInfoInterface carries seven more virtuals ahead of
	// removeStagingRoom than ZH's: GameSpyInfo::addStagingRoom @0x635120
	// calls it through slot 0xA8 where this header puts it at 0x8C. Only the
	// slot index is proven - what the seven added methods are, and whether
	// they really sit here rather than earlier, is unknown - so they are
	// stubs placed immediately in front of the pin.
	virtual void _bfme_gsi_slot35( void ) { }
	virtual void _bfme_gsi_slot36( void ) { }
	virtual void _bfme_gsi_slot37( void ) { }
	virtual void _bfme_gsi_slot38( void ) { }
	virtual void _bfme_gsi_slot39( void ) { }
	virtual void _bfme_gsi_slot40( void ) { }
	virtual void _bfme_gsi_slot41( void ) { }
