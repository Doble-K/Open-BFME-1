...
public:
	...
	// BFME's Snapshot ctor/dtor are inline and empty: retail ModuleData
	// constructors store their vtable and members directly with no call to
	// ??0Snapshot@@QAE@XZ at all (e.g. ProneUpdateModuleData @0x29FE30 is
	// just `mov eax,ecx; mov [eax],vtbl; mov [eax+8],1.0f; ret`), where the
	// ZH out-of-line declaration forces a base-ctor call.
	Snapshot( void ) { }
	~Snapshot( void ) { }
