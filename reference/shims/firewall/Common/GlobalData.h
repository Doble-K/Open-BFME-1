...
// TU-scoped stand-in for Common/GlobalData.h, scoped through
// /Ireference/shims/firewall. See the firewall block note below.
...
public:
  ...
  Int   m_statsInterval;       ///< if so, how many is N?
	...
	// +0x798 and +0x794. The padding goes in front of the block rather than
