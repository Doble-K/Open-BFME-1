...
#endif
	// BFME inserted members here that are not yet identified; retail pins
	// m_map at this+0x2FF4 (updateCenter @0x6C8E50, getMaxCellHeight @0x6C6CB0,
	// removeAllTerrainBibs @0x6CB050 all read [this+0x2FF4]), ZH puts it at 0x2808.
	char _bfme_pad_pre_map[0x7EC];
